...
//           <div>
//             <p className="text-success">
//               To Calculate Annual Labor Cost Savings
//               Click The Annual Labor Cost Saved Button And Fill The Necessary
//               Details
//             </p>
//           </div>
...
const ReferralROIApp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${apiUrl}/calculate`, rawData);
      setResult(response.data);
      setShowROIResult(true);
    } catch (error) {
      if (error.response && error.response.data) {
  ...
  return (
    <div className="container py-5">
      ...
      <div>
        <p className="text-success">
          Please enter the below details and click the Calculate Total Licensing
          Expense button
        </p>
      </div>
      ...
      {showROIResult && result && (
        <div className="container mt-3">
          ...
          {/* Annual Labor Cost Saved button */}
          {!showAnnual && !showImpact && (
            <div className="d-grid gap-2 mt-3">
              <p className="text-success mb-1">
                To calculate Annual Labor Cost Savings, click the button below
              </p>
              <button
                type="button"
                className="btn btn-primary btn-lg shadow-sm d-flex align-items-center justify-content-center gap-2"
          ...
          {/* ReferralAIRevenueImpact output */}
          {showImpact && <ReferralAIRevenueImpact />}
        </div>
      )}
    </div>
